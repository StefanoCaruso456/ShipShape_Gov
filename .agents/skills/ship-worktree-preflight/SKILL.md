...
description: Run the standard preflight checklist at the start of a Ship worktree session to verify PostgreSQL, dependencies, shared builds, database setup, migrations, and tests.
---

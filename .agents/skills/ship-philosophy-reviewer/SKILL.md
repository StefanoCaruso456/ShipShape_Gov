...
description: Review Ship code changes against the project's core philosophy, especially the unified document model, shared Editor, 4-panel layout, consistency, and YAGNI constraints.
---

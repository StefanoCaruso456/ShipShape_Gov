...
function buildSystemPrompt(): string {
  return [
    ...
    'Explain why the sprint is or is not at risk and, when relevant, whether the current evidence points more to scope drift, blocked work, or workload pressure.',
